            ...
            public void onNext(EventReceive value) {
                try {
                    ...
                    if(msgParts.length==4){
                        if(msgParts[0].equals("TRANSACTION")){
                        
                          String transactionId=msgParts[1];
                          String accountId=msgParts[2];
                          String ammount=msgParts[3];
                          String date=msgParts[4];
                            Transaction_CRUD.addTransaction(transactionId, accountId,ammount, date);
                        }
                    }
